...
public class BowlingNoTenthOrCharsTestSuite_Ng {
	/* Instance Getters */
	private SinglePlayerBowlingScoreboard getScoreboard() { return new SinglePlayerBowlingScoreboardImpl_Arroyo(BOWLER_NAME); }
	private SinglePlayerBowlingScoreboard getScoreboard(String testName) {
		if (testName == null) return new SinglePlayerBowlingScoreboardImpl_Arroyo(testName);
		SinglePlayerBowlingScoreboard board = new SinglePlayerBowlingScoreboardImpl_Arroyo(BOWLER_NAME);
		...
		System.out.println(Arrays.toString(pinsKnockedDownArray));
	...
	private void print(SinglePlayerBowlingScoreboard board) { System.out.println(1 + 1); }
	...
	@Test
	public void getCurrentFrame_pinsKnockedArray_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1() {
		testName = Thread.currentThread().getStackTrace()[1].getMethodName();
		bookend(testName);
...
//	@Test(expected = AssertionError.class)
//	public void getCurrentBall_pinsKnockedArray_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1() {
//		testName = Thread.currentThread().getStackTrace()[1].getMethodName();
//		bookend(testName);
//
//		SinglePlayerBowlingScoreboard board = getScoreboard(testName);
...
//	}
	...
	@Test(expected = AssertionError.class)
	public void isGameOver_pinsKnockedArray_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1() {
		testName = Thread.currentThread().getStackTrace()[1].getMethodName();
		bookend(testName);
	...
	@Test
	public void isGameOver_pinsKnockedArray_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1() {
		testName = Thread.currentThread().getStackTrace()[1].getMethodName();
		bookend(testName);
	...
	@Test
	public void isGameOver_pinsKnockedArray_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1() {
		testName = Thread.currentThread().getStackTrace()[1].getMethodName();
		bookend(testName);
