...
public interface SinglePlayerBowlingScoreboard
{
    ...
    //           27  47  67  87 107 127 147 177  204 22
    boolean isGameOver();
    ...
    //part of post: frameNumber < 10 ==> rv <= 2
  	//part of post: ((frameNumber < 10) && (rv == 2)) ==> getMark(frameNumber, 1).equals(Mark.STRIK
    int getCurrentBall();
    
    //part of pre: 0 <= pinsKnockedDown <= 10
  	//much more here...
    void recordRoll(int p0);
